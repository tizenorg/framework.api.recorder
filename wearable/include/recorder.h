...
/**
 * @brief Enumerations for recorder states.
 */
typedef enum
{
...
/**
 * @brief Sets the resolution of video recording.
 *
...
/**
 * @brief Gets the resolution of video recording.
 *
 * @param[in] recorder	The handle to media recorder
 ...
 * @retval    #RECORDER_ERROR_NONE Successful
 * @retval    #RECORDER_ERROR_INVALID_PARAMETER Invalid parameter
 * @post	This function invokes recorder_supported_video_resolution_cb() repeatly to retrieve each supported video resolution.
 *
 * @see	recorder_set_video_resolution()
 * @see	recorder_get_video_resolution()
...
/**
 * @brief Sets the video orientation in video metadata tag.
 *
 * @param[in]	recorder	The handle to media recorder
...
/**
 * @brief Gets the video orientation in video metadata tag.
 *
 * @param[in]	recorder	The handle to media recorder
